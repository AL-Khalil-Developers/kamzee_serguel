package com.kamzee.app.adapters.others;
...
import com.kamzee.app.home.settings.WebUrlsActivity;
        ...
        if (viewHolder.getItemViewType() == FOOTER_VIEW){
            ...
            if (productModel.getType().equals(BillingClient.SkuType.INAPP)){
                ...
                switch (productModel.getSku()) {
                    case Config.CREDIT_5000:

                        holder.ItemName.setText(mActivity.getString(R.string.credits_5000));
                    ...
                    case Config.CREDIT_50000:
                        ...
                        holder.ItemName.setText(mActivity.getString(R.string.credits_50000));
                    ...
                    case Config.CREDIT_150000:
                        ...
                        holder.ItemName.setText(mActivity.getString(R.string.credits_150000));
                    ...
                    case Config.CREDIT_400000:
                        ...
                        holder.ItemName.setText(mActivity.getString(R.string.credits_400000));
                    ...
                    case Config.CREDIT_800000:
                        ...
                        holder.ItemName.setText(mActivity.getString(R.string.credits_800000));
                    ...
                    case Config.CREDIT_1600000:
                        ...
                        holder.ItemName.setText(mActivity.getString(R.string.credits_1600000));
                    ...
                    case Config.CREDIT_1200000:
                        ...
                        holder.ItemName.setText(mActivity.getString(R.string.credits_1200000));
