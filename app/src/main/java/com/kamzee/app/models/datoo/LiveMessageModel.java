...
public class LiveMessageModel extends ParseObject {
    ...
    public static final String MESSAGE_TYPE_BAN = "BAN";
    ...
    public User getSenderAuthor() {
        ...
        try {
            return (User) this.fetchIfNeeded().getParseObject(SENDER_AUTHOR);
    ...
    public User getBannedUser() {
        ...
        try {
            return (User) this.fetchIfNeeded().getParseObject(BANNED_USER);
        } catch (ParseException e) {
            e.printStackTrace();
        }
