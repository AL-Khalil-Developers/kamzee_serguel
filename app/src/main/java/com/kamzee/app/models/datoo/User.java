...
public class User extends ParseUser {
    ...
    private static final String Coin = "credit";
    ...
    public void addCoin(int credit) {
        increment(Coin, credit);
    }

    public void removeCoin(int credit) {
        increment(Coin, - credit);
    }

//    public void addCoin(int Coin) {
//        increment(String.valueOf(Coin), Coin);
//    }
//
