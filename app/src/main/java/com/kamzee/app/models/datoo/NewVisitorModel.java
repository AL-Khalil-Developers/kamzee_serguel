...
@ParseClassName("NewVisitor")
public class NewVisitorModel extends ParseObject {
    ...
    public static ParseQuery<NewVisitorModel> getNewVisitorQuery(){
        return ParseQuery.getQuery(NewVisitorModel.class);
    }
}
