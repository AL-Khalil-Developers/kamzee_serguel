...
@ParseClassName("NewLike")
public class NewLikeModel extends ParseObject {
    ...
    public static ParseQuery<NewLikeModel> getNewLikeQuery(){
        return ParseQuery.getQuery(NewLikeModel.class);
    }
}
