...
import com.kamzee.app.adapters.others.CountriesFetcher;
import com.kamzee.app.adapters.others.TextWatcherAdapter;
import com.kamzee.app.app.Application;
import com.kamzee.app.app.Config;
import com.kamzee.app.app.Constants;
import com.kamzee.app.app.DispatchActivity;
...
import com.kamzee.app.utils.CustomProgressView;
...
public class PhoneLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadingDialog = new ProgressDialog(com.kamzee.app.auth.PhoneLoginActivity.this);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    QuickHelp.showToast(com.kamzee.app.auth.PhoneLoginActivity.this, getString(R.string.sms_quota_out), true);
    ...
    public void ErrorCode(){
        ...
        QuickHelp.hideLoading(com.kamzee.app.auth.PhoneLoginActivity.this);

        QuickHelp.showNotification(com.kamzee.app.auth.PhoneLoginActivity.this, getString(R.string.error_ocurred), true);
        btnNext.setText(getString(R.string.next));
        btnNext.setEnabled(true);
    ...
    private void verificationOfCode() {
        ...
        if (!code.isEmpty()) {
            ...
            QuickHelp.showToast(com.kamzee.app.auth.PhoneLoginActivity.this, getString(R.string.please_enter_your_ver_code), true);
        }
    }
    ...
    public void LoginWithPhoneNumberInBackground(FirebaseUser firebaseUser){
        ...
        userParseQuery.getFirstInBackground((user, e) -> {
            if (user != null){
                ...
                parseUser.addCoin(Config.WelcomeCredit);
