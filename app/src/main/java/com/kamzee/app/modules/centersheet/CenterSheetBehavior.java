 ...
 * a bottom sheet.
 */
public class CenterSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {

    /**
     * Callback for monitoring events about bottom sheets.
     */
    public abstract static class CenterSheetCallback {
    ...
    private CenterSheetCallback mCallback;
     ...
     */
    public CenterSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        mMaxOffset = mParentHeight - peekHeight;
     ...
     */
    public void setCenterSheetCallback(CenterSheetCallback callback) {
        mCallback = callback;
    }
    ...
    /**
     * A utility function to get the {@link CenterSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link CenterSheetBehavior}.
     * @return The {@link CenterSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> CenterSheetBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof CenterSheetBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with centerSheetBehavior");
        }
        return (CenterSheetBehavior<V>) behavior;
    }
