package com.kamzee.app.modules.parsegooglesignin;
   ...
   public static void signIn(Intent signInIntent){
    ...
    public static void LoginInBackground(GoogleSignInAccount account){
        ...
        if (account != null){
            ...
            parseUserParseQuery.whereEqualTo(User.COL_EMAIL, account.getEmail());
            parseUserParseQuery.getFirstInBackground((parseUser, e) -> {
                if (e == null){

                   /* ParseException exception = new ParseException(ParseException.EMAIL_TAKEN, Application.getInstance().getString(R.string.com_parse_ui_email_taken_toast));
                    ...
                    ParseUser.logInWithInBackground(AUTH_TYPE, getAuthData(account)).continueWith(task -> {
                        if (task.isCompleted()){
                            ...
                            ParseException exception = new ParseException(ParseException.OTHER_CAUSE, Application.getInstance().getString(R.string.login_error));
