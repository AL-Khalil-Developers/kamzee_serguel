...
import com.kamzee.app.auth.ForgotFragment;
import com.kamzee.app.auth.LoginFragment;
import com.kamzee.app.auth.SignupFragment;
...
public class AngopapoSignupActivity extends AppCompatActivity implements
    ...
    public static final String LOG_TAG = "AngopapoSignupActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(fragmentContainer,
                    SignupFragment.newInstance(configOptions)).commit();
        }
    }
