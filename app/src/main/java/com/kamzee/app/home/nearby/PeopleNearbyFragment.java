package com.kamzee.app.home.nearby;
...
import com.kamzee.app.adapters.datoo.UsersNearAdapter;
import com.kamzee.app.adapters.datoo.UsersNearSpotLightAdapter;
...
import com.kamzee.app.utils.StaggeredGridLayoutManagerWrapper;
...
public class PeopleNearbyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
            ...
            public void onLoaded(List<User> usersNear, ParseException e) {
                ...
                if (usersNear != null) {
                    ...
                    if (usersNear.size() > 0) {
                        ...
                        mErrorImage.setImageResource(R.drawable.ic_tabbar_pnb);
        ...
        StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManagerWrapper(2, StaggeredGridLayoutManager.VERTICAL);
