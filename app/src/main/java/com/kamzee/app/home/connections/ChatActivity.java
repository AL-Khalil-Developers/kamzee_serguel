...
import com.kamzee.app.adapters.datoo.ChatAdapter;
import com.kamzee.app.adapters.others.PhotosChatUploadAdapter;
...
import com.kamzee.app.models.others.UploadModel;
import com.kamzee.app.modules.camera.ImagePro;
import com.kamzee.app.modules.circularimageview.CircleImageView;
import com.kamzee.app.utils.DateUtils;
import com.kamzee.app.utils.ItemOffsetDecoration;
...
import static com.kamzee.app.modules.camera.ImagePro.CAMERA_CODE;
...
public class ChatActivity extends AppCompatActivity {
    ...
    public void loadUser(){
        ...
        mToolbarAvatar.setOnClickListener(v -> QuickActions.showProfile(this, mUser, false));
    ...
    public void prepareMessage(boolean isMessageFile, String imagePath){
        ...
        if (Config.isPaidMessagesActivated && mCurrentUser.getColGender().equals(User.GENDER_MALE) && !mCurrentUser.isPremium()) {
            ...
            if (QuickHelp.isToday(mCurrentUser.getMessageLimitCounterToday())){
