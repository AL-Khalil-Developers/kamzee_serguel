package com.kamzee.app.home.payments;
...
import com.kamzee.app.adapters.others.PaymentProductListSkuAdapter;
import com.kamzee.app.adapters.others.SliderPagerAdapter;
...
import com.kamzee.app.models.others.PaymentSliderModel;
import com.kamzee.app.modules.dotsindicator.SpringDotsIndicator;
...
import static com.kamzee.app.app.Config.CREDIT_5000;
...
public class PaymentsActivity extends AppCompatActivity implements PaymentProductListSkuAdapter.ItemViewHolder.OnItemSelectedListener, PurchasesUpdatedListener {
    ...
    public final String ITEM_CATEGORY_CREDITS = "CREDITS";
    public final String ITEM_CATEGORY_PREMIUM = "PREMIUM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.getTabAt(0).getIcon().setColorFilter(QuickHelp.getColor(com.kamzee.app.home.payments.PaymentsActivity.this, R.color.light_blue_400), PorterDuff.Mode.SRC_ATOP);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 0){
                    ...
                    tab.getIcon().setColorFilter(QuickHelp.getColor(com.kamzee.app.home.payments.PaymentsActivity.this, R.color.light_blue_400), PorterDuff.Mode.SRC_ATOP);

                } else if (tab.getPosition() == 1){

                    if (Config.FLUTTER_WAVE_ENABLED){
                        PaymentMethodSelected = PAYMENT_CARD;
                        tab.getIcon().setColorFilter(QuickHelp.getColor(com.kamzee.app.home.payments.PaymentsActivity.this, R.color.orange_4), PorterDuff.Mode.SRC_ATOP);
                    } else if (Config.PAYPAL_ENABLED){
                        PaymentMethodSelected = PAYMENT_PAYPAL;
                        tab.getIcon().setColorFilter(QuickHelp.getColor(com.kamzee.app.home.payments.PaymentsActivity.this, R.color.light_blue_700), PorterDuff.Mode.SRC_ATOP);
                    }
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                tab.getIcon().setColorFilter(QuickHelp.getColor(com.kamzee.app.home.payments.PaymentsActivity.this, R.color.grey_2), PorterDuff.Mode.SRC_ATOP);
    ...
    public void createSlider(){
        ...
        if (mType.equals(TYPE_DATOO_PREMIUM)){
            ...
            if (mUser != null && !mUser.getColGender().isEmpty()){
                ...
                if (mCurrentUser != null && !mCurrentUser.getColGender().isEmpty()){
            ...
            if (mUser != null){
                 gender1 = isMale ? getString(R.string.him) : getString(R.string.her);
                 gender2 = isMale ? getString(R.string.hes) : getString(R.string.shes);
            } else {
                gender1 = isMale ? getString(R.string.girls) : getString(R.string.boys);
                gender2 = isMale ? getString(R.string.they_are) : getString(R.string.they_are);
            }

            PaymentSliderModel crush = new PaymentSliderModel();
            crush.setType(PaymentSliderModel.SLIDER_YPE_NORMAL);
            crush.setUser(mUser);
            crush.setCredit(String.format("%s %s", Config.CRUSH_CREDIT_NEEDED, getString(R.string.credits_)));
            crush.setTitle(String.format(getString(R.string.cush_service_text), gender1, gender2));
            crush.setBadgeImage(R.drawable.ic_badge_feature_crush);

            if (mType.equals(TYPE_3X_POPULAR)){

                paymentSliderModelList.add(popular3x);
                if (Config.isCrushAdsEnabled && Config.CRUSH_CREDIT_NEEDED > 0){ paymentSliderModelList.add(crush); }
    ...
    public void initSKUCredits() {
        ...
        creditsPurchase.add(Config.CREDIT_1600000);
        creditsPurchase.add(Config.CREDIT_1200000);
        creditsPurchase.add(Config.CREDIT_800000);
        creditsPurchase.add(Config.CREDIT_400000);
        creditsPurchase.add(Config.CREDIT_150000);
        creditsPurchase.add(Config.CREDIT_50000);
        creditsPurchase.add(Config.CREDIT_20000);
        creditsPurchase.add(CREDIT_5000);
    ...
    public void initPurchaseFlow(){
        ...
        if (PaymentMethodSelected.equals(PAYMENT_GOOGLE)){
            ...
            mBillingClient.launchBillingFlow(com.kamzee.app.home.payments.PaymentsActivity.this, flowParams);
            ...
            Meta UserGender = new Meta("Gender", mCurrentUser.getColGender());
            ...
            if (!mCurrentUser.getEmail().isEmpty()){
                ...
                QuickHelp.showToast(com.kamzee.app.home.payments.PaymentsActivity.this, getString(R.string.basic_info_needed), true);
                QuickHelp.goToActivityWithNoClean(com.kamzee.app.home.payments.PaymentsActivity.this, BasicInfoActivity.class);
            ...
            PayPalPayment payPalPayment = new PayPalPayment(new BigDecimal(amountFinal),
                    productModel.getPriceCurrencyCode(),
    ...
    public void logPurchaseEvent(SkuDetails productModel){

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(Application.getInstance());

        String transactionId = QuickHelp.getRandomString(10);
        String currency = productModel.getPriceCurrencyCode();
        String SKU = productModel.getSku();
        String itemName = productModel.getDescription();
        Double value = itemPrice;
        String method = PaymentMethodSelected;
        String category = mType;

        Bundle item = new Bundle();
        item.putString(FirebaseAnalytics.Param.ITEM_ID, SKU);
        item.putString(FirebaseAnalytics.Param.ITEM_NAME, itemName);
        item.putString(FirebaseAnalytics.Param.ITEM_CATEGORY, category);
        item.putDouble(FirebaseAnalytics.Param.PRICE, value);

        Bundle purchaseParams = new Bundle();
        purchaseParams.putString(FirebaseAnalytics.Param.TRANSACTION_ID, transactionId);
        purchaseParams.putString(FirebaseAnalytics.Param.AFFILIATION, method);
        purchaseParams.putString(FirebaseAnalytics.Param.CURRENCY, currency.toUpperCase());
        purchaseParams.putDouble(FirebaseAnalytics.Param.VALUE, value);
        purchaseParams.putParcelableArray(FirebaseAnalytics.Param.ITEMS, new Parcelable[]{ item });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RaveConstants.RAVE_REQUEST_CODE && data != null) {
            ...
            if (resultCode == RavePayActivity.RESULT_SUCCESS) {
                ...
                logPurchaseEvent(productModel);
            }
            else if (resultCode == RavePayActivity.RESULT_ERROR) {
                //Toast.makeText(this, "ERROR " + message, Toast.LENGTH_SHORT).show();

                QuickHelp.showNotification(com.kamzee.app.home.payments.PaymentsActivity.this, getString(R.string.error_try_again_later), true);
            } else if (resultCode == RavePayActivity.RESULT_CANCELLED) {
                //Toast.makeText(this, "CANCELLED " + message, Toast.LENGTH_SHORT).show();

                QuickHelp.showNotification(com.kamzee.app.home.payments.PaymentsActivity.this, getString(R.string.purchase_canceled), true);
            }
    ...
    public void creditUser(String Sku){
        ...
        switch (Sku) {
            ...
            case CREDIT_5000:
                ...
                addCreditToAccount(5000);
                break;
            case Config.CREDIT_50000:

                addCreditToAccount(50000);

                break;
            case Config.CREDIT_150000:

                addCreditToAccount(150000);
                break;

            case Config.CREDIT_400000:

                addCreditToAccount(400000);
                break;

            case Config.CREDIT_800000:

                addCreditToAccount(800000);
                break;

            case Config.CREDIT_1600000:

                addCreditToAccount(1600000);
                break;

            case Config.CREDIT_1200000:

                addCreditToAccount(1200000);
                break;
                ...
                if (purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
                    ...
                    switch (purchase.getSku()) {
                        ...
                        case CREDIT_5000:
                            ...
                            acknowledgePurchaseConsume(5000, purchase);
                            break;
                        case Config.CREDIT_50000:

                            acknowledgePurchaseConsume(50000, purchase);

                            break;
                        case Config.CREDIT_150000:

                            acknowledgePurchaseConsume(150000, purchase);
                            break;

                        case Config.CREDIT_400000:

                            acknowledgePurchaseConsume(400000, purchase);
                            break;

                        case Config.CREDIT_800000:

                            acknowledgePurchaseConsume(800000, purchase);
                            break;

                        case Config.CREDIT_1600000:

                            acknowledgePurchaseConsume(1600000, purchase);
                            break;

                        case Config.CREDIT_1200000:

                            acknowledgePurchaseConsume(1200000, purchase);
                            break;
    ...
    public void addCreditToAccount(int credits) {
        ...
        mCurrentUser.saveEventually(e -> {
            ...
            if (e == null){
                ...
                QuickHelp.showNotification(com.kamzee.app.home.payments.PaymentsActivity.this, credits + " " + getString(R.string.credit_added_to_yo_a), false);
    ...
    public void addPremiumLimitDate(int days) {
        ...
        mCurrentUser.saveEventually(e -> {
            ...
            if (e == null){
                ...
                QuickHelp.showNotification(com.kamzee.app.home.payments.PaymentsActivity.this, getString(R.string.you_are_premium), false);
            }
        });
    }
