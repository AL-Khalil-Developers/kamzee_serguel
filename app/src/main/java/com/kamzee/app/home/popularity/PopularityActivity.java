package com.kamzee.app.home.popularity;
...
public class PopularityActivity extends AppCompatActivity {
            ...
            if (rewardedAd.isLoaded()) {
                ...
                RewardedAdCallback adCallback = new RewardedAdCallback() {
                    ...
                    public void onUserEarnedReward(@NonNull RewardItem reward) {
                        ...
                        mCurrentUser.addCoin(reward.getAmount());
    ...
    public void goToPurchase(String type){
        ...
        if (type.equals(PaymentsActivity.TYPE_RISE_UP) && mCurrentUser.getCoins() >= Config.TYPE_RISE_UP){

            QuickHelp.goToActivityFeatureActivation(this, type);

        } else if (type.equals(PaymentsActivity.TYPE_GET_MORE_VISITS) && mCurrentUser.getCoins() >= Config.TYPE_GET_MORE_VISITS){

            QuickHelp.goToActivityFeatureActivation(this, type);

        } else if (type.equals(PaymentsActivity.TYPE_ADD_EXTRA_SHOWS) && mCurrentUser.getCoins() >= Config.TYPE_ADD_EXTRA_SHOWS){

            QuickHelp.goToActivityFeatureActivation(this, type);

        } else if (type.equals(PaymentsActivity.TYPE_SHOW_IM_ONLINE) && mCurrentUser.getCoins() >= Config.TYPE_SHOW_IM_ONLINE){

            QuickHelp.goToActivityFeatureActivation(this, type);

        }  else if (type.equals(PaymentsActivity.TYPE_3X_POPULAR) && mCurrentUser.getCoins() >= Config.TYPE_3X_POPULAR){
