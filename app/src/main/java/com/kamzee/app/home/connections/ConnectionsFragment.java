package com.kamzee.app.home.connections;
...
import com.kamzee.app.adapters.datoo.ConnectionsAdapter;
import com.kamzee.app.adapters.datoo.ConnectionsSpotLightAdapter;
...
import com.kamzee.app.home.encounters.LikedYouActivity;
import com.kamzee.app.home.payments.PaymentsActivity;
import com.kamzee.app.home.popularity.PopularityActivity;
import com.kamzee.app.models.datoo.ConnectionListModel;
import com.kamzee.app.models.datoo.User;
import com.kamzee.app.modules.expansionpanel.ExpansionLayout;
import com.kamzee.app.utils.SharedPrefUtil;
...
public class ConnectionsFragment extends Fragment {
    ...
    private View.OnClickListener mOnClearClickListener = v -> {
        ...
        mTitleHeader.setText(getString(R.string.connection_all_connections));
    ...
    private void initializeDropDown(){
        ...
        mChatsLayout.setOnClickListener(v -> {
            ...
            clearHeader = true;
            expansionLayout.toggle(true);
            mTitleHeader.setText(getString(R.string.connection_chats));
        ...
        mOnlineLayout.setOnClickListener(v -> {
            ...
            expansionLayout.toggle(true);
            mTitleHeader.setText(getString(R.string.connection_online));
        ...
        mVistsLayout.setOnClickListener(v -> {
            ...
            expansionLayout.toggle(true);
            mTitleHeader.setText(getString(R.string.connection_visits));
        ...
        mFavoritesLayout.setOnClickListener(v -> {
            ...
            clearHeader = true;
            expansionLayout.toggle(true);
            mTitleHeader.setText(getString(R.string.connection_favorites));
        ...
        messageQuery.findInBackground((messages,e) -> {
            ...
            if (e == null) {
                ...
                if (messages.size() > 0){
                    ...
                    if (isUnique && isAdded()) hideLoading(getString(R.string.no_connection_yet), getString(R.string.no_chat_yet_explain), R.drawable.ic_tabbar_mess);
                }
                ...
                if (isUnique && isAdded()) hideLoading(getString(R.string.not_internet_connection), getString(R.string.settings_no_inte), R.drawable.ic_blocker_large_connection_grey1);

            } else {

                if (isUnique && isAdded()) hideLoading(e.getLocalizedMessage(), getString(R.string.error_ocurred), R.drawable.ic_close);
            }
        ...
        messageQuery.findInBackground((messages,e) -> {
            ...
            if (e == null) {
                ...
                if (messages.size() > 0){
                    ...
                    if (isUnique && isAdded()){
                        hideLoading(getString(R.string.no_chat_yet), getString(R.string.no_chat_yet_explain), R.drawable.ic_tabbar_mess);
                    }
                }
                ...
                if (isUnique && isAdded()){
                    hideLoading(getString(R.string.not_internet_connection), getString(R.string.settings_no_inte), R.drawable.ic_blocker_large_connection_grey1);
                }

            } else {

                if (isUnique && isAdded()){
                    hideLoading(e.getLocalizedMessage(), getString(R.string.error_ocurred), R.drawable.ic_close);
                }
            }
        ...
        visitorModelParseQuery.findInBackground((visitors, e) -> {
            ...
            if (e == null){
                ...
                if (visitors.size() > 0){
                    ...
                    if (isUnique){
                        hideLoading(getString(R.string.no_visit_yet), getString(R.string.no_visit_yet_explain), R.drawable.ic_navigation_bar_visible);
                    }
                }
        ...
        query.findInBackground((favorites, e) -> {
            ...
            if (e == null){
                ...
                if (favorites.size() > 0){
                    ...
                    if (isUnique){
                        hideLoading(getString(R.string.no_favorite_yet), getString(R.string.no_favorite_yet_explain), R.drawable.ic_profile_favorite);
                    }
